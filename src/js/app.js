...
const delay = 6000 // A delay to have your logo present
...
HeaderVideo.prototype.appendIframe = function () {
    ...
    var html = '<video autoplay muted id="header-video__teaser-video" class="header-video__teaser-video"><source src="' + source + '.webm" type="video/mp4"><source src="' + source + '.mp4" type="video/mp4"></video>'
    this.$element.append( html )
}
...
HeaderVideo.prototype.appendTeaserVideo = function () {
    var source = this.videoDetails.teaser
    var html = '<video autoplay loop muted id="header-video__teaser-video" class="header-video__teaser-video"><source src="' + source + '.webm" type="video/mp4"><source src="' + source + '.mp4" type="video/mp4"></video>'
    this.$element.append( html )
}
